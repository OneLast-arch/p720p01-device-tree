...
text = path.read_text()
marker = "P720P01: restore metadata mapping and DE keys after the UI unmount"

if marker in text:
    print(f"P720P01 metadata/FBE remount fix already installed in {path}")
    raise SystemExit(0)
...
print(f"Installed P720P01 metadata/FBE remount fix in {path}")
