...
text = path.read_text()
marker = "P720P01: reject an empty Gatekeeper hardware auth token"

if marker in text:
    print(f"P720P01 Gatekeeper token guard already installed in {path}")
    raise SystemExit(0)
...
print(f"Installed P720P01 Gatekeeper hardware auth token guard in {path}")
